...
with open('sql/02_load_hospital_data.sql', 'w', encoding='utf-8') as f:
    ...
    f.write("TRUNCATE TABLE `Procedure_Team`;\n")
    f.write("TRUNCATE TABLE `Medical_Procedures`;\n")
    f.write("TRUNCATE TABLE `Evaluation`;\n")
    f.write("TRUNCATE TABLE `LAB_EXAMS`;\n")
    f.write("TRUNCATE TABLE `Administrative_Staff_has_Shift`;\n")
    f.write("TRUNCATE TABLE `Nurse_has_Shift`;\n")
    f.write("TRUNCATE TABLE `DOCTOR_has_Shift`;\n")
    f.write("TRUNCATE TABLE `Shift`;\n")
    f.write("TRUNCATE TABLE `Triage`;\n")
    f.write("TRUNCATE TABLE `Hospitalization`;\n")
    f.write("TRUNCATE TABLE `DOCTOR_has_Department`;\n")
    f.write("TRUNCATE TABLE `Patient_Allergy`;\n")
    f.write("TRUNCATE TABLE `Emergency_Contact`;\n")
    f.write("TRUNCATE TABLE `Patient`;\n")
    f.write("TRUNCATE TABLE `ROOM`;\n")
    f.write("TRUNCATE TABLE `Administrative_Staff`;\n")
    f.write("TRUNCATE TABLE `Nurse`;\n")
    f.write("TRUNCATE TABLE `BEDS`;\n")
    f.write("TRUNCATE TABLE `Department`;\n")
    f.write("TRUNCATE TABLE `DOCTOR`;\n")
    f.write("TRUNCATE TABLE `PERSONNEL`;\n")
